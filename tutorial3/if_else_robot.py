...
In this example, I added a condition variable that controls whether the body color of the robots should be based on the predefined colors or set to a default color (in this case, "gray") when the condition is False. You can change the condition variable as needed to control the appearance of your robots based on a specific condition.
